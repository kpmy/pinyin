...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
  ...
  }], ["", "data.dart",, N, {}], ["", "pinyin.dart",, E, {
    "^": "",
    next: function() {
      var next, t1, t2, t3, t4, t5, variants, correct, i, v;
      next = $.$get$rnd().nextInt$1($.$get$data().length);
      t1 = $.$get$x();
      t1.toString;
      t1.setAttribute("data-answer", C.JSInt_methods.toString$0(next));
      t1 = $.$get$x();
      t2 = $.$get$data();
      t3 = t2.length;
      if (next < 0 || next >= t3)
      ...
      t1.textContent = t4[2];
      variants = [];
      C.JSArray_methods.set$length(variants, 3);
      correct = $.$get$rnd().nextInt$1(variants.length);
      if (correct < 0 || correct >= variants.length)
        return H.ioore(variants, correct);
      ...
      for (i = 0; i < 3;)
        if (i === correct)
          ...
          if (t1 === 1) {
            t1 = variants.length;
            if (0 >= t1)
              return H.ioore(variants, 0);
            variants[0] = correct;
            if (1 >= t1)
              return H.ioore(variants, 1);
            variants[1] = correct;
            if (2 >= t1)
              return H.ioore(variants, 2);
            variants[2] = correct;
            break;
          } else {
            v = $.$get$rnd().nextInt$1(t1);
            if (v !== next) {
              if (i >= variants.length)
                return H.ioore(variants, i);
              variants[i] = v;
              ++i;
            }
          }
      ...
      if (1 >= t3.length)
        return H.ioore(t3, 1);
      t1.setAttribute("value", t3[1]);
      t3 = $.$get$a();
      t3.toString;
      if (0 >= variants.length)
        return H.ioore(variants, 0);
      t3.setAttribute("data-answer", J.toString$0$(variants[0]));
      t3 = $.$get$b();
      t3.toString;
      t1 = $.$get$data();
      ...
      if (1 >= t2.length)
        return H.ioore(t2, 1);
      t3.setAttribute("value", t2[1]);
      t2 = $.$get$b();
      t2.toString;
      if (1 >= variants.length)
        return H.ioore(variants, 1);
      t2.setAttribute("data-answer", J.toString$0$(variants[1]));
      t2 = $.$get$c();
      t2.toString;
      t3 = $.$get$data();
      if (2 >= variants.length)
        return H.ioore(variants, 2);
      t1 = variants[2];
      ...
      if (1 >= t1.length)
        return H.ioore(t1, 1);
      t2.setAttribute("value", t1[1]);
      t1 = $.$get$c();
      t1.toString;
      if (2 >= variants.length)
        return H.ioore(variants, 2);
      t1.setAttribute("data-answer", J.toString$0$(variants[2]));
    },
    initScore: function() {
      var i, t1, t2;
      for (i = 0; t1 = $.$get$dict(), i < 36; ++i) {
        t2 = $.$get$score();
        t1 = t1[i];
        if (0 >= t1.length)
          return H.ioore(t1, 0);
    ...
    reset: [function() {
      $.$get$x().setAttribute("style", "color: black;");
      E.nextSym();
    }, "call$0", "pinyin__reset$closure", 0, 0, 1],
    answer: function(variant) {
      var t1, t2, t3;
      if (J.$eq$(H.Primitives_parseInt($.$get$x().getAttribute("data-answer"), null, null), variant)) {
        t1 = $.$get$score();
        t2 = $.$get$data();
        if (variant >>> 0 !== variant || variant >= t2.length)
          return H.ioore(t2, variant);
        t2 = t2[variant];
        if (0 >= t2.length)
          return H.ioore(t2, 0);
        t2 = t2[0];
        ...
        $.$get$x().setAttribute("style", "color: green;");
        P.Timer_Timer(C.Duration_500000, E.pinyin__reset$closure());
      } else {
        $.$get$x().setAttribute("style", "color: red;");
        P.Timer_Timer(C.Duration_500000, E.pinyin__reset$closure());
      }
    },
    main: [function() {
      var t1 = J.get$onClick$x($.$get$a());
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.main_closure()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onClick$x($.$get$b());
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.main_closure0()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onClick$x($.$get$c());
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new E.main_closure1()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      E.initScore();
      E.nextSym();
    }, "call$0", "pinyin__main$closure", 0, 0, 1],
    main_closure: {
      "^": "Closure:2;",
      call$1: function(e) {
        return E.answer(H.Primitives_parseInt($.$get$a().getAttribute("data-answer"), null, null));
      }
    },
    main_closure0: {
      "^": "Closure:2;",
      call$1: function(e) {
        return E.answer(H.Primitives_parseInt($.$get$b().getAttribute("data-answer"), null, null));
      }
    },
    main_closure1: {
      "^": "Closure:2;",
      call$1: function(e) {
        return E.answer(H.Primitives_parseInt($.$get$c().getAttribute("data-answer"), null, null));
      }
    }
  }, 1]];
  setupProgram(dart, 0);
  ...
  (function(lazies) {
    ...
    return [];
  }, "_toStringVisiting", "dict", "$get$dict", function() {
    return [["\u4f60", "ni\u0306", "\u0442\u044b"], ["\u597d", "ha\u0306o", "\u0445\u043e\u0440\u043e\u0448\u043e"], ["\u5417", "ma", "?"], ["\u6211", "wo\u0306", "\u044f"], ["\u5f88", "he\u0306n", "\u043e\u0447\u0435\u043d\u044c"], ["\u5462", "ne", "\u043d\u043e"], ["\u4e5f", "ye\u0306", "\u0442\u043e\u0436\u0435"], ["\u5fd9", "ma\u0301ng", "\u0437\u0430\u043d\u044f\u0442"], ["\u4e0d", "bu\u0300", "\u043d\u0435\u0442"], ["\u54e5\u54e5", "ge\u0304ge\u0304", "\u0441\u0442\u0430\u0440\u0448\u0438\u0439 \u0431\u0440\u0430\u0442"], ["\u7b2c\u7b2c", "di\u0300di\u0300", "\u043c\u043b\u0430\u0434\u0448\u0438\u0439 \u0431\u0440\u0430\u0442"], ["\u4eec", "men", "\u043c\u043d. \u0447\u0438\u0441\u043b\u043e"], ["\u90fd", "do\u0304u", "\u0432\u0441\u0435"], ["\u4ed6", "ta\u0304", "\u043e\u043d"], ["\u8fd9", "zhe\u0300", "\u044d\u0442\u043e"], ["\u662f", "shi\u0300", "\u0435\u0441\u0442\u044c, \u0434\u0430, \u043f\u0440\u0430\u0432\u0438\u043b\u044c\u043d\u043e"], ["\u7238\u7238", "ba\u0300ba\u0300", "\u043f\u0430\u043f\u0430"], ["\u5988\u5988", "ma\u0304ma\u0304", "\u043c\u0430\u043c\u0430"], ["\u670b\u53cb", "pe\u0301ngyou", "\u0434\u0440\u0443\u0433"], ["\u5927\u592b", "da\u0300ifu", "\u0432\u0440\u0430\u0447"], ["\u7684", "de", "\u043f\u0440\u0438\u0442\u044f\u0436\u0430\u043d\u0438\u0435"], ["\u8f66", "che\u0304", "\u0442\u0440\u0430\u043d\u0441\u043f\u043e\u0440\u0442"], ["\u90a3", "na\u0300", "\u0442\u043e"], ["\u5979", "ta\u0304'", "\u043e\u043d\u0430"], ["\u4e66", "shu\u0304", "\u043a\u043d\u0438\u0433\u0430"], ["\u54ea", "na\u0306", "\u043a\u0430\u043a\u043e\u0439"], ["\u56fd", "guo\u0301", "\u0441\u0442\u0440\u0430\u043d\u0430"], ["\u4eba", "re\u0301n", "\u043b\u044e\u0434\u0438"], ["\u8c01", "she\u0301i", "\u043a\u0442\u043e"], ["\u8001\u5e08", "la\u0306oshi\u0304", "\u0443\u0447\u0438\u0442\u0435\u043b\u044c"], ["\u8001", "la\u0306o", "\u0441\u0442\u0430\u0440\u044b\u0439"], ["\u5e08", "shi\u0304", "\u043c\u0430\u0441\u0442\u0435\u0440"], ["\u6c49\u8bed", "ha\u0300nyu\u0306", "\u043a\u0438\u0442\u0430\u0439\u0441\u043a\u0438\u0439 \u044f\u0437\u044b\u043a"], ["\u6c49", "ha\u0300n", "\u043a\u0438\u0442\u0430\u0439\u0441\u043a\u0438\u0439"], ["\u8bed", "yu\u0306", "\u044f\u0437\u044b\u043a"], ["\u4e2d\u56fd", "Zho\u0304ngguo\u0301"]];
  }, "dict", "rnd", "$get$rnd", function() {
    return C.C__JSRandom;
  }, "rnd", "x", "$get$x", function() {
    return W.querySelector("#text");
  }, "x", "tip", "$get$tip", function() {
    return W.querySelector("#tip");
  }, "tip", "a", "$get$a", function() {
    return W.querySelector("#a");
  }, "a", "b", "$get$b", function() {
    return W.querySelector("#b");
  }, "b", "c", "$get$c", function() {
    return W.querySelector("#c");
  }, "c", "data", "$get$data", function() {
    return [];
  }, "data", "score", "$get$score", function() {
    return P.LinkedHashMap__makeEmpty();
  }, "score"]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(E.pinyin__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(E.pinyin__main$closure(), a);
...
//# sourceMappingURL=pinyin.dart.js.map
